<?php
/*
Le but de cet exercice est de produire une chanson folklorique (Alouette) à partir
de données se trouvant dans les variables d'un fichier d'inclusion.

alouette_statique.php : La version statique de la page.

alouette_avec_echos.php : La version pas très efficace où l'on fait une multitude de
    echo dans la page et les boucles sont directement dans le HTML

alouette_avec_variables.php : Une version plus normalisée où les éléments répétitifs sont
    mis dans des variables et l'affichage se fait une seule fois dans la page

alouette_avec_fonction.php : Une version pas encore optimale où l'on utilise des fonction.
    notamment la fonction appel_reponse, qui est beaucoup utilisée.

alouette_avec_classe.php : Une version presque optimale où l'on utilise une classe et
